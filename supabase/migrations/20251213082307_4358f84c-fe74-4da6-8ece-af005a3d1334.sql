...
-- Web projects policies - public read, admin write
CREATE POLICY "Anyone can view web projects"
ON public.web_projects FOR SELECT
TO anon, authenticated
USING (true);

CREATE POLICY "Admins can insert web projects"
ON public.web_projects FOR INSERT
TO authenticated
WITH CHECK (public.has_role(auth.uid(), 'admin'));

CREATE POLICY "Admins can update web projects"
ON public.web_projects FOR UPDATE
TO authenticated
USING (public.has_role(auth.uid(), 'admin'));

CREATE POLICY "Admins can delete web projects"
ON public.web_projects FOR DELETE
TO authenticated
USING (public.has_role(auth.uid(), 'admin'));

-- Social posts policies - public read, admin write
