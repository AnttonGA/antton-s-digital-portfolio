...
const fallbackExperiences = [
  {
    ...
    description: [
      "Dirección de estrategia de marketing y crecimiento",
      "Gestión de equipo y desarrollo de producto",
      "Estrategia go-to-market y adquisición de clientes",
    ],
    display_order: 0,
  },
  {
    ...
    role: "Erasmus for Entrepreneurs",
